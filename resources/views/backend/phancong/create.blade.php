                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  id="nhiemvu-input" value="" required name="nhiemvu">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="overflow-x-auto">
                                            <table class="min-w-full bg-white border border-gray-200 rounded-lg"
                                                ...
                                                <thead class="bg-blue-100">
                                                    <tr>
                                                        <th class="py-3 px-6 text-left text-xs font-medium text-blue-700 uppercase tracking-wider">
                                                            Chọn</th>
