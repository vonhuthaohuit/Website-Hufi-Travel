<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href=""><img src="{{ asset('frontend/images/logo.png') }}" alt="HUFI Travel" width="50px"> HUFI Travel</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setActive(['admin.tour']) }}"><a class="nav-link"
                            href="{{ route('admin.tour.*') }}">Tours</a></li>
                    <li
                        class="{{ setActive([
                            'admin.tour.*',
                            'admin.products-image-gallery.*',
