...
<div class="content container pt-5">
    <div class="container-fluid">
        ...
        <form name="tourBooking" method="post" class="form-horizontal frm-tour-booking" role="form" action="/">
            <ul class="nav nav-tabs nav-justified frm-tour-booking-step" role="tablist">
                ...
                <div class="content_book tour-des">
                    <header class="content-header">
                        <h3 class="py-3">Đặt tour thành công!</h3>
                    </header>
                    ...
                    <div style="max-width: 900px; text-align:center; margin:auto; margin-top:30px">
                        ...
                        <br>
                        Click <a class="text-info" href="/">vào đây</a> trở về trang chủ.</p>
                        <p>Một email xác nhận đã được gửi đến địa chỉ <a href="mailto:info@Hufitravel.com.vn /sales@Hufitravel.com.vn">info@Hufitravel.com.vn /sales@Hufitravel.com.vn</a>.</p>
                    </div>
