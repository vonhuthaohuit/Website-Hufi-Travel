...
<section class="about-one">
    <div class="about-one-shape-1 wow slideInLeft animated" data-wow-delay="100ms" data-wow-duration="2500ms"
        style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInLeft;">
    </div>
    <div class="container-xl">
        <div class="row">
            <div class="col-xl-6 wow fadeInLeft animated" data-wow-duration="1500ms"
                style="visibility: visible; animation-duration: 1500ms; animation-name: fadeInLeft;">
                <div class="about-one__left">
                    <div class="about-one__img-box">
                        <div class="about-one__img">
                            <img src="{{ asset('frontend/images/about-one-img-1.png') }}" alt="">
                        </div>
                        <div class="about-one__call">
                            ...
                            <div class="about-one__call-number">
                                <p>Đặt tour ngay</p>
                                <h4><a href="tel:666-888-0000">0963 114 775</a></h4>
                            </div>
                        </div>
