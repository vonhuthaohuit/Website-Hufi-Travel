...
model_path = os.path.join(os.getcwd(),'public' ,'storage', 'resnet50.pth')
...
index_path = os.path.join(os.getcwd(), 'storage', 'faiss_index.index')  # Đường dẫn tuyệt đối tới FAISS index
...
image_names_path = os.path.join(os.getcwd(), 'storage', 'image_names.txt')  # Đường dẫn tuyệt đối tới tên ảnh
