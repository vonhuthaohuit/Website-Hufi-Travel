...
data_folder = "public/frontend/images/tour"
...
# save vao file
vector_file = os.path.join("app", "Traits", "model_ai", "app", "public", "vectors.pkl")
path_file = os.path.join("app", "Traits", "model_ai", "app", "public", "paths.pkl")
